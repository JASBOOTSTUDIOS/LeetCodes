...
function romanToInt(s) {
    var romanNumber = { "I": 1, "V": 5, "X": 10, "L": 50, "C": 100, "D": 500, "M": 1000 };
    var integer = 0;
    var status = 2000;
...
console.log("El resultado es ".concat(romanToInt("MCMXCIV"), ".")); // 1994.
console.log("El resultado es ".concat(romanToInt("LVIII"), ".")); // 58.
console.log("El resultado es ".concat(romanToInt("III"), ".")); // 3
console.log("El resultado es ".concat(romanToInt("MC"), ".")); // 1100.
console.log("El resultado es ".concat(romanToInt("DLC"), ".")); // 1600
console.log("El resultado es ".concat(romanToInt("VDC"), ".")); // 695
